...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <?php if (in_array($santri_bayar['status_pembayaran'], [1, 2])): ?>
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-sm-8">
                        <div class="card shadow">
                            ...
                            <form action="<?= base_url('pembayaran/pembayaran_santri/' . $santri_bayar['santri_pembayaran_id']); ?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="row justify-content-center mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control nominal-form <?= (form_error('nominal_bayar_panitia') != '') ? 'is-invalid' : ''; ?>" id="nominal_bayar_panitia" name="nominal_bayar_panitia" placeholder="Tulis nominal pembayaran" autocomplete="off" value="<?= set_value('nominal_bayar_panitia'); ?>">
                                                    <div class="invalid-feedback"><?= form_error('nominal_bayar_panitia'); ?></div>
                                                </div>
                                                <input type="hidden" name="bayar_nominal_panitia" id="bayar_nominal_panitia" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
