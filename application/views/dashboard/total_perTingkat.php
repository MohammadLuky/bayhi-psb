            ...
            <?php if ($this->session->userdata('role_id') != 5): ?>
                <div class="row">
                    ...
                    foreach ($hasil_perhitungan as $data) {
                        if ($data['tingkat_id'] == 1) {
                            $grouped_by_tingkat[$data['tingkat_id']][] = $data;
                        } elseif ($data['tingkat_id'] == 2) {
                            $grouped_by_tingkat[$data['tingkat_id']][] = $data;
                        } elseif ($data['tingkat_id'] == 3) {
                            $grouped_by_tingkat[$data['tingkat_id']][] = $data;
                        }
                    }
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <?php foreach ($Alltingkat as $tingkat) : ?>
                                        <?php if ($getIDtingkat == $tingkat['id_tingkat_sekolah']): ?>
                                            <h5 class="card-title text-center"><?= $tingkat['nama_tingkat']; ?></h5>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                    <table class="table">
                                        <thead>
